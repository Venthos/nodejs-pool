...
function Coin(data){
    ...
    this.coinDevAddress = "Sumoo3sC2PkGS85rzrjKJa1XeLBoX9oqiWEhb7Sm7BzCb69xfVqCh7adNQjbTqaUux5zXaZV39gdSDhtoCHMwUNrSP47xZFiUQR";  // ArqTras
    this.poolDevAddress = "Sumoo1DGS7c9LEKZNipsiDEqRzaUB3ws7YHfUiiZpx9SQDhdYGEEbZjRET26ewuYEWAZ8uKrz6vpUZkEVY7mDCZyGnQhkLpxKmy";  // MoneroOcean
    ...
    this.prefix = 2864026;
    this.intPrefix = 2864027; //cnUtil.address_decode_integrated(new Buffer(config.poolServer.poolAddress));
    ...
    this.cryptoNight = multiHashing.cryptonight_heavy;
